...
if hash or SudoBot(msg) or DevBLACK W(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBLACK W(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBLACK W(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBLACK W(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBLACK W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBLACK W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBLACK W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local BLACK _Msg = ''  
if msgs < 100 then 
BLACK _Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BLACK _Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BLACK _Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BLACK _Msg = 'متفاعل' 
elseif msgs < 1200 then 
BLACK _Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BLACK _Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BLACK _Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BLACK _Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BLACK _Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BLACK _Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BLACK _Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BLACK _Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BLACK _Msg = 'انت التفاعل'  
end 
return BLACK _Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@SOURCE Alexander")  
...
SourceBLACK r = '☤ اهلا عزيزي\n☤ انا بوت اسمي '..Namebot..'\n☤ اختصاصي حمايه المجموعات\n☤ من التكرار والسب…\n☤ لتفعيلي اتبع الاخطوات…↓\n☤ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[☤ [قناة سورس البوت](http://t.me/vp_zo)'
end 
send(msg.chat_id_, msg.id_, SourceBLACK r) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevBLACK W(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBLACK W(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BLACK _Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل' and DevBLACK W(msg) then  
...
if text == 'تعطيل التواصل' and DevBLACK W(msg) then  
...
if text == 'تفعيل البوت خدمي' and DevBLACK W(msg) then  
...
if text == 'تعطيل البوت خدمي' and DevBLACK W(msg) then  
...
if text == 'ضع كليشه ستارت' and DevBLACK W(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'☤ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevBLACK W(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'☤ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر' and DevBLACK W(msg) then 
...
if text == 'تحديث السورس' and DevBLACK W(msg) then 
os.execute('rm -rf BLACK .lua')
os.execute('wget https://raw.githubusercontent.com/jack1eljoker1/BLACK 22/master/BLACK .lua')
send(msg.chat_id_, msg.id_,'☤ تم تحديث السورس \n☤ لديك اخر اصدار لسورس بلاك\n☤ الاصدار » { V²}')
dofile('BLACK .lua')  
end
if text == 'الاصدار' and DevBLACK W(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'☤ اصدار سورس بلاك \n☤ الاصدار »{ V²}')
end
if text == "ضع اسم للبوت" and DevBLACK W(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"☤ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات' and DevBLACK W(msg) then 
...
if text == 'المشتركين' and DevBLACK W(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☤ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات' and DevBLACK W(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☤ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين") and DevBLACK W(msg) then
...
if text == ("قائمه العام") and DevBLACK W(msg) then
...
if text == ("قائمه الكتم العام") and DevBLACK W(msg) then
...
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DevBLACK W(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل الان اذاعتك؟ \n☤ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه" and msg.reply_to_message_id_ == 0 and DevBLACK W(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل الان اذاعتك؟ \n☤ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and DevBLACK W(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل الان اذاعتك؟ \n☤ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and DevBLACK W(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص" and msg.reply_to_message_id_ == 0  and DevBLACK W(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه' and DevBLACK W(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين" and DevBLACK W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف المجموعات" and DevBLACK W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'☤  عدد المجموعات الان » { '..#group..' }'..BLACK k..''..BLACK ..'\n☤  الان عدد المجموعات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBLACK W(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevBLACK W(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBLACK W(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBLACK W(msg) then
...
local BLACK 1_Msg = database:get(bot_id.."BLACK 1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BLACK 1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if BLACK _Msg and not Special(msg) then  
local BLACK _Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BLACK _Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBLACK W(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBLACK W(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBLACK W(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☤ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBLACK W(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☤ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ☤ " and DevBLACK W(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "☤ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☤ $") and DevBLACK W(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☤ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ☤ " and DevBLACK W(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ☤ " and DevBLACK W(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "☤ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ☤ " and DevBLACK W(msg) then  
...
function SOURCE Alexander_name(t1,t2)
if t2.id_ then 
...
bnnaGet(msg.sender_user_id_, SOURCE Alexander_name)
end
...
function amir_BLACK a_new(BLACK 1,BLACK 2)
if BLACK 2 and BLACK 2.first_name_ then 
if BLACK 2.first_name_:match("(.*)"..database:get(bot_id.."BLACK :teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BLACK :Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BLACK _nnn = database:get(bot_id.."BLACK :nump"..msg.chat_id_) or 5
local BLACK _nnn2 = database:get(bot_id.."BLACK :nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BLACK _nnn2) == tonumber(BLACK _nnn) or tonumber(BLACK _nnn2) > tonumber(BLACK _nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BLACK :nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☤ عزيزي >>["..BLACK 2.username_.."](https://t.me/"..(BLACK 2.username_ or "vp_zo")..")\n☤ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BLACK :teh"..msg.chat_id_).."} بجانب اسمك\n☤ عدد المحاولات المتبقيه {"..(tonumber(BLACK _nnn) - tonumber(BLACK _nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BLACK a_new)
end
end
...
local BLACK ChengName = database:get(bot_id.."BLACK :Cheng:Name"..data.id_)
if not data.first_name_ then 
if BLACK ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BLACK ChengName..']')
database:del(bot_id.."BLACK :Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BLACK ChengName ~= data.first_name_ then 
local Text = {
...
if data.id_ then 
if data.id_ ~= bot_id then
local BLACK ChengUserName = database:get(bot_id.."BLACK :Cheng:UserName"..data.id_)
if not data.username_ then 
if BLACK ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BLACK ChengUserName..']')
database:del(bot_id.."BLACK :Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BLACK ChengUserName ~= data.username_ then 
local Text = {
'غيرت معرفك ليه 🙂😹',
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BLACK ChengPhoto = database:get(bot_id.."BLACK :Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BLACK ChengPhoto then 
send(msg.chat_id_, msg.id_, "القمر حذف صورو ليه ؟")
database:del(bot_id.."BLACK :Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BLACK ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ليه غيرت صورتك ",
...
local Text =[[
*🇲🇵Alexander مرحب بيك في سورس *
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url="t.me/V_P_E"},
},
{
...
if text == 'رفع نسخه الاحتياطيه' and DevBLACK W(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBLACK W(msg) then    
dofile('BLACK .lua')  
send(msg.chat_id_, msg.id_, '☤ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBLACK W(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBLACK W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if tonumber(result.sender_user_id_) == tonumber(1458654225) then  
...
if text and text:match("^حظر عام @(.*)$")  and DevBLACK W(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBLACK W(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBLACK W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBLACK W(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBLACK W(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBLACK W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBLACK W(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBLACK W(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBLACK W(msg) then
...
if database:get(bot_id.."SOURCE Alexander:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'SOURCE Alexander:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."SOURCE Alexander:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'SOURCE Alexander:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevBLACK W(msg) then
t = '☤ ملفات السورس بلاك ↓\n SOURCE Alexander² \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBLACK W(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBLACK W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جاك' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/SOURCE Alexander) ') 
return false
end
...
database:set(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☤ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BLACK 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BLACK 1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"☤ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BLACK 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BLACK 1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BLACK 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"☤ ارسل الكلمه الان")  
database:set(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLACK 1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BLACK 1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BLACK 1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BLACK 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLACK 1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BLACK 1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n☤ قائمة المنع \n SOURCE Alexander²\n"
for k,v in pairs(list) do  
local BLACK _Msg = database:get(bot_id.."BLACK 1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BLACK _Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBLACK W(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'☤ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBLACK W(msg) then
...
if text == 'تفعيل الاذاعه' and DevBLACK W(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBLACK W(msg) then  
...
if text == 'تفعيل البوت الخدمي' and DevBLACK W(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevBLACK W(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if not database:get(bot_id..'SOURCE Alexander:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'SOURCE Alexander:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..BLACK _Msg[math.random(#BLACK _Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBLACK W(msg) then 
...
if text == ("مسح ردود المطور") and DevBLACK W(msg) then 
...
if text == ("ردود المطور") and DevBLACK W(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n☤ قائمة ردود المطور \n SOURCE Alexander²\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevBLACK W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and DevBLACK W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevBLACK W(msg) then   
...
if text == 'تعطيل المغادره' and DevBLACK W(msg) then  
...
-- vardump(data) 
BLACK dx(msg.chat_id_, msg.id_, '☤ ايدي المجموعة » ( '..msg.chat_id_..' )\n☤ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n☤ عدد المحظورين » ( *'..data.kicked_count_..' )*\n☤ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBLACK W(msg) then
...
☤ م10 ➢ أوامر الأعضاء
ــــــــــــــــــــــ☤ـــــــــــــــــــــ
☤ 𝑆𝑂𝑈𝑅𝐶𝐸 [˹ BLACK.](t.me/vp_zo) ☤
ــــــــــــــــــــــ☤ـــــــــــــــــــــ
☤ 𝐷𝐸𝑉 >> [˹ 𝚋𝚊𝚗𝚍𝚊 𖢜.](t.me/uu_ban)
ــــــــــــــــــــــ☤ـــــــــــــــــــــ 
]]
...
zx = JSON.decode(zh)
t = "\n☤ قائمه الزخرفه \nٴ☤  SOURCE Alexander²☤○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ☤  SOURCE Alexander²☤○ٴ\n☤ [[˹ SOURCE Alexander.](http://t.me/vp_zo)](t.me/vp_zo)➢ ')
end
...
------------------------------------------------------------------------
local revorb0t = database:get(bot_id.."BLACK 1:Add:Filter:Rp2"..text..result.chat_id_)   
if revorb0t then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"☤ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n☤ ["..revorb0t.."] \n") 
...
------------------------------------------------------------------------
if text then
local BLACK 1_Msg = database:get(bot_id.."BLACK 1:Add:Filter:Rp2"..text..result.chat_id_)   
if BLACK 1_Msg then    
send(msg.chat_id_, msg.id_,"☤ "..Alexander 1_Msg)
